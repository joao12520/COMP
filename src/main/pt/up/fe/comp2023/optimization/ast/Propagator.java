...
import pt.up.fe.comp2023.analysis.ASTMethodGenerator;
import pt.up.fe.comp2023.analysis.SymbolTablePopulate;
...
public class Propagator  extends AJmmVisitor<String, Propagator.DeletedNSymbol> {
